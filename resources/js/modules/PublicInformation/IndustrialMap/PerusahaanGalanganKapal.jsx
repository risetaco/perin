...
import { perusahaan } from "@/data/public-information/perusahaan-galangan-kapal";
import { Table, Pagination, TextInput } from "flowbite-react";
import { paginate  } from "@/utils/paginate";


export default function PerusahaanGalanganKapal() {
    ...
    <div className="grid grid-cols-1 gap-4">
      ...
      <Table hoverable={true} border>
        <Table.Head>
          ...
          <Table.HeadCell>Kabupaten/Kota Kantor</Table.HeadCell>
          <Table.HeadCell>Kabupaten/Kota Galangan Kapal</Table.HeadCell>
        </Table.Head>
        <Table.Body className="divide-y">
          {filtered.data.map((data) => (
            <Table.Row>
              ...
              <Table.Cell>{data.office_city}</Table.Cell>
